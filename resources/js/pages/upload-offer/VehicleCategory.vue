      ...
      <div class="question-section mb-4">
        ...
        <ul v-else class="options-list">
          <li
            ...
            :key="vehicle.id"
            :class="[
              'item position-relative ' + vehicle.slug,
              { active: vehicle.id === getState.vehicleCategory },
            ]"
...
export default {
  ...
  setup() {
    ...
    const { fetch: vehicleCategories } = useFetcher(
      "get.categories",
      null,
      false
    );
    ...
    function go() {
      ...
      router.push({
        name: "upload.vehicle",
        params: { vehicleID: getState.value.vehicleCategory },
      });
    }
    ...
    function setState(data) {
      ...
      store.commit("uploadOffer/setVehicleState", {
        key: "vehicleCategory",
        value: data,
      });
    }
